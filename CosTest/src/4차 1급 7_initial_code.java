...
class Solution471 
{
    ...
    public int[] solution471(int monsterAttackPoint, int warriorAttackPoint, int healingPoint) {
    ...
    public static void main(String[] args) {
        ...
        int healingPoint = 30;
        int[] ret = sol.solution471(monsterAttackPoint, warriorAttackPoint, healingPoint);
